...
AVAILABLE_TOOLS = [
    ...
    {"name": "OpenCode CLI", "value": "opencode", "checked": True},
...
class InteractiveConfigurator:
    ...
    def ask_project_name(self) -> str:
        ...
        return questionary.text("项目名称:", default=default_name, style=custom_style).ask()
    ...
    def ask_tools_to_install(self) -> List[str]:
        ...
        for tool in AVAILABLE_TOOLS:
            ...
            choices.append({"name": tool["name"], "value": tool["value"], "checked": checked})

        selected = questionary.checkbox(
            "选择要安装的工具:", choices=choices, style=custom_style
        ).ask()
    ...
    def ask_node_version(self) -> str:
        ...
        version_choice = questionary.select(
            "Node.js 版本:", choices=choices, default=default, style=custom_style
        ).ask()
    ...
    def ask_python_version(self) -> str:
        ...
        version = questionary.text(
            "Python 版本 (用于 Conda):", default=default_version, style=custom_style
        ).ask()
    ...
    def ask_use_china_mirrors(self) -> bool:
        ...
        return questionary.confirm(
            "是否配置中国大陆镜像源 (加速下载)?", default=use_mirrors, style=custom_style
        ).ask()
    ...
    def confirm_config(self, config: Config) -> bool:
        ...
        return questionary.confirm("确认以上配置并继续?", default=True, style=custom_style).ask()
