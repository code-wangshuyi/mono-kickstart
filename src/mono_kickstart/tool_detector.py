...
class ToolDetector:
        ...
        if nvm_sh.exists():
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    return ToolStatus(name="nvm", installed=True, version=version, path=str(nvm_sh))
            except (subprocess.TimeoutExpired, subprocess.SubprocessError):
                pass

            # 如果无法获取版本，但文件存在，仍然认为已安装
            return ToolStatus(name="nvm", installed=True, version=None, path=str(nvm_sh))
    ...
    def detect_node(self) -> ToolStatus:
        ...
        return ToolStatus(name="node", installed=True, version=version, path=path)
    ...
    def detect_conda(self) -> ToolStatus:
        ...
        return ToolStatus(name="conda", installed=True, version=version, path=path)
    ...
    def detect_bun(self) -> ToolStatus:
        ...
        return ToolStatus(name="bun", installed=True, version=version, path=path)
    ...
    def detect_uv(self) -> ToolStatus:
        ...
        return ToolStatus(name="uv", installed=True, version=version, path=path)
    ...
    def detect_claude_code(self) -> ToolStatus:
        ...
        return ToolStatus(name="claude-code", installed=True, version=version, path=path)
    ...
    def detect_codex(self) -> ToolStatus:
        ...
        return ToolStatus(name="codex", installed=True, version=version, path=path)

    def detect_opencode(self) -> ToolStatus:
        if not self.is_command_available("opencode"):
            return ToolStatus(name="opencode", installed=False)

        version = self.get_command_version("opencode", "--version")
    ...
    def detect_npx(self) -> ToolStatus:
        ...
        return ToolStatus(name="npx", installed=True, version=version, path=path)
    ...
    def detect_spec_kit(self) -> ToolStatus:
        ...
        return ToolStatus(name="spec-kit", installed=True, version=version, path=path)
    ...
    def detect_uipro(self) -> ToolStatus:
        ...
        return ToolStatus(name="uipro", installed=True, version=version, path=path)
    ...
    def detect_gh(self) -> ToolStatus:
        ...
        return ToolStatus(name="gh", installed=True, version=version, path=path)
    ...
    def detect_bmad(self) -> ToolStatus:
        ...
        return ToolStatus(name="bmad-method", installed=True, version=version, path=path)
    ...
    def detect_pip(self) -> ToolStatus:
        ...
        return ToolStatus(name="pip", installed=True, version=version, path=path)
